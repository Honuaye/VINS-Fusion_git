...
template <typename T>
void YawPitchRollToRotationMatrix(const T yaw,
                                  const T pitch,
                                  const T roll,
                                  T R[9]) {
...
struct FourDOFWeightError {
    ...
    static ceres::CostFunction* Create(const double t_x,
                                       ...
                                       const double roll_i) {
        return (
            new ceres::AutoDiffCostFunction<FourDOFWeightError, 4, 1, 3, 1, 3>(
